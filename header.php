...
<body <?php body_class(); ?>>
	<header class="header position_fixed w_100" data-header-type="home">
    ...
    <nav class="nav position_fixed d_none align_items-start w_100" data-bg-trans="black-01" data-nav-type="home">
