...
<section id="skills" class="section bg_img" data-bg-color="grey-tint-09" data-bg-img="skills" style="background-image: url(<?= the_field('skill_bg_img'); ?>);">
    <div class="row d_flex flex_column mx_auto w_100 h_100">
        <div class="skills__container d_flex flex_column justify_content-center w_100 h_100">
            ...
            ?>
                <div class="skillbox d_flex flex_column">
                    <h3 class="skillbox__title d_flex align_items-center" data-txt-color="black" data-txt-weight="600" data-txt-transform="uppercase"><span><?= get_the_title(); ?></span><span data-txt-color="grey" data-txt-style="italic"><?= get_the_excerpt(); ?>%</span></h3>
                    <div class="skillbox__percent w_100" data-bg-color="grey-tint-06">
                        <span class="d_block w_100 h_100" data-bg-color="primary" style="max-width: <?= get_the_excerpt(); ?>%;"></span>
                    </div>
                </div>
            <?php endwhile; else : ?>
    ...
    ?>
        <figure class="statisticsbox d_flex justify_content-center align_items-center w_100" data-bg-color="primary-shade-01">
            <picture class="d_block w_100 h_100">
                <img src="<?= wp_get_attachment_url( get_post_thumbnail_id( $post->ID ) ); ?>" class="d_block max_100 w_100 h_100 object_cover" alt="<?= $alt_text; ?>">
            </picture>
...
<section id="products" class="w_100" data-bg-color="white">
    <div class="products__container w_100">
    <?php
        $temp = $wp_query;
        $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
    ...
    <a href="<?= the_field('work_archive_page_link');?>" class="products__btn d_block w_100" data-txt-color="grey" data-txt-weight="600" data-txt-align="center" data-txt-transform="uppercase" data-bg-color="grey" data-txt-decoration="none">load more work</a>
</section>

<section id="work" class="section" data-bg-color="white">
    <div class="row d_flex flex_column align_items-center mx_auto w_100">
        <h2 class="section__title d_block w_100" data-txt-color="black" data-txt-weight="600" data-txt-align="center" data-txt-transform="capitalize"><?= the_field('work_title'); ?></h2>
        <p class="section__txt d_block w_100" data-txt-color="grey" data-txt-weight="400" data-txt-align="center"><?= the_field('work_text'); ?></p>
        <div class="work__video position_relative d_flex justify_content-center align_items-center w_100">
            <iframe src="<?= the_field('work_embed_url'); ?>" class="work__iframe position_relative d_block w_100 h_100" allow="autoplay" allowfullscreen></iframe>
            <div class="work__play position_absolute d_flex justify_content-center align_items-center w_100 h_100 bg_img" style="background-image: url('<?= the_field('work_thumbnail'); ?>');" data-bg-img="work">
                <button type="button" class="work__btn d_flex align_items-center justify_content-center w_100 h_100 radius_100" data-bg-color="primary">
                    <svg xmlns="http://www.w3.org/2000/svg" class="d_block w_100 h_100 fill_white" viewBox="0 0 16 16"><path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z"/></svg>
                </button>
            </div>
        </div>
    </div>
...
<section id="services" class="section" data-bg-color="grey-tint-07">
    <div class="row d_flex flow_wrap justify_content-center align_items-center mx_auto w_100">
    <?php
        $temp = $wp_query;
        $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
        ...
        $alt_text = get_post_meta($img_id , '_wp_attachment_image_alt', true); 
    ?>
        <div class="serviceBox d_flex flex_column justify_content-center align_items-center w_100" data-txt-align="center" data-bg-color="grey-tint-08">
            <picture>
                <img src="<?= wp_get_attachment_url( get_post_thumbnail_id( $post->ID ) ); ?>" class="d_block max_100 w_100" alt="<?= $alt_text; ?>">
            </picture>
            
            <h3 class="serviceBox__title d_block w_100" data-txt-color="black" data-txt-weight="600" data-txt-transform="uppercase"><?= get_the_title(); ?></h3>
            <div class="serviceBox_description d_block w_100" data-txt-weight="400" data-txt-color="grey"><?= get_the_content(); ?></div>
        </div>
    <?php endwhile; else : ?>
        <p>no hay contenido que mostrar</p>
    <?php 
...
<section id="testimonials" class="section" data-bg-color="primary">
    <div class="row d_flex flex_column justify_content-center align_items-center mx_auto w_100">
        <div class="testimonials__carousel d_flex flex_column max_100 w_100">
            <?php
                $temp = $wp_query;
                $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
                $post_per_page = -1; // -1 shows all posts
                ...
                if (have_posts()) : while ($wp_query->have_posts()) : $wp_query->the_post();
            ?>
            <div class="testimonialbox flex_column align_items-center" data-txt-color="white" data-txt-align="center" data-txt-weight="500">
                <div class="testimonialbox__content" data-txt-color="white" data-txt-weight="500">
                    <?= get_the_content(); ?>
                </div>
                <p class="testimonialbox__author d_block w_100" data-txt-transform="uppercase"><?= get_the_title(); ?></p>
            </div>
            <?php endwhile; else : ?>
                <p>no hay contenido que mostrar</p>
            <?php 
...
<section id="clients" data-bg-color="white">
    <div class="row d_flex flow_wrap justify_content-center align_items-center mx_auto w_100">
        <div class="clients__carousel max_100 w_100">
        <?php
            $temp = $wp_query;
            $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
            $post_per_page = -1; // -1 shows all posts
            ...
            $alt_text = get_post_meta($img_id , '_wp_attachment_image_alt', true); 
        ?>
            <picture class="clientbox justify_content-center align_items-center w_100">
                <img src="<?= wp_get_attachment_url( get_post_thumbnail_id( $post->ID ) ); ?>" class="d_block w_100 object_cover" alt="<?= $alt_text; ?>">
            </picture>
        <?php endwhile; else : ?>
            <p>no hay contenido que mostrar</p>
        <?php 
...
<section id="contact" class="section" data-bg-color="grey-tint-08">
    <div class="row d_flex flow_wrap justify_content-center align_items-center mx_auto w_100">
        <h2 class="section__title d_block w_100" data-txt-color="black" data-txt-weight="600" data-txt-align="center" data-txt-transform="capitalize"><?= the_field('contact_title'); ?></h2>
        <p class="section__txt d_block w_100" data-txt-color="grey" data-txt-weight="400" data-txt-align="center"><?= the_field('contact_text'); ?></p>           
        <?= the_content(); ?>
    </div>
</section>